...
import { View,Text, StyleSheet, Image, Button, TouchableOpacity, useColorScheme,SafeAreaView, StatusBar, } from "react-native/types";
    ...
    return (
        ...
        <View style= {styles.whiteSheet}/>
              <SafeAreaView>
                ...
                {`//information`}
                <View>
                <Text style={{fontWeight: "bold", fontSize: 20, textAlign: "center", marginTop: "20", color: currentPokemon.color, }}>
                    Information
                </Text>
